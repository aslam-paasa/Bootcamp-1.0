 ...
 *   and the server will echo the message back to you, called heartbeat.
 *   If the server doesn't receive a message from the client in a certain
 *   time, it will assume that the client is disconnected and will close
 *   the connection.
*/
