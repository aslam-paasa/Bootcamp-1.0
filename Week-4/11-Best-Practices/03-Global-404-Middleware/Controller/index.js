 ...
 * - In this exercise, you'll create a global 404 middleware to handle
 *   requests for routes that don't exist.
 *   1. Create 404 Middleware: Define a middleware fn that takes req &
 *      res parameters.
 *   2. Send 404 Response: Respond with a 404 status code and a message
 *      indicating that the requested route is not found.
*/
