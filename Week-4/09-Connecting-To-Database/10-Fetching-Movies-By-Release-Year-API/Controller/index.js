/**
 * Fetching movies by release year API:
 * - Design a GET route at /movies/release-years that allows users to 
 *   access movies sorted by their release years in ascending order. 
 *   Utilize the readMoviesByReleaseYear function to retrieve the movie
 *   data. Handle errors proficiently.
 *   1. Create a GET Route: Set up a GET route at /movies/release-years
 *      to handle requests for movies sorted by release years.
 *   2. Retrieve Movies: In the route handler, use the readMoviesByReleaseYear
 *      function to find and sort movies by their release years in 
 *      ascending order.
