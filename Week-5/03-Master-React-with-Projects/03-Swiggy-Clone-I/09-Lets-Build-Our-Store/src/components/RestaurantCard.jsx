 ...
 * - It will takes RestaurantCard and return a new component with extra 
 *   features like promoted label.
 *   a. input  - RestaurantCard as Input Component
 *   b. return - New Component with Promoted Label on top of the RestaurantCard
*/
export const withPromotedLabel = () => {
  return (props) => {
    return (
      <div className="relative">
        <label className="absolute top-4 left-4 bg-black text-white px-2 py-1 rounded-lg text-sm font-medium z-10">
          Ad
        </label>
