  ...
  return (
    <>
      ...
      {data.length <= 0 ? (
        ...
        /**
         * InPageNavigaion Component:
         * - Props Sent: teams (Array of team names e.g., ["MI", "KKR"])
         * - Children 1: Team 1 Players (Array of player objects e.g., [{fullName: "Rohit Sharma", role: "Batsman"}, {fullName: "Virat Kohli", role: "Batsman"}])
         * - Children 2: Team 2 Players (Array of player objects e.g., [{fullName: "Kane Williamson", role: "Batsman"}, {fullName: "Ross Taylor", role: "Batsman"}])
         * */
        <InPageNavigaion
          teams={[
        ...
        >
          {/* Children 1: Team 1 Players in a list */}
          ...
          {/* Children 2: Team 2 Players in a list */}
