 ...
 * > "The Function.prototype.apply() method calls the specified function with
 *    a given this value, and arguments provided as an array (or an 
 *    array-like object)."
*/
...
/**
 * Explanation:
 * > The Function.prototype.apply() function is a built-in method in 
 *   JavaScript that allows you to call a function with a specified this 
 *   value and an array of arguments. 
 * > Like Function.prototype.call(), it allows you to explicitly define the 
 *   context (this value) in which the function will be executed.
 * 
 * Solution:
 * > As Function.prototype.apply() takes in an array of arguments, we have 
 *   to define a default empty array parameter for argArray if we are to 
 *   spread it, because we can only spread iterables.
*/
 ...
 *   itself. If the this context is not used at all, the following will work:
*/
 ...
 *   immediately. 
 * > It allows us to permanently bind a specific context (this value) to the
 *   function and partially apply arguments if needed. This is exactly what 
 *   we need to bridge the gap in the solution above.
*/
 ...
 *   a. Function.prototype.call takes in a comma-separated list of arguments
 *   b. Function.prototype.apply takes in an array of arguments
*/
