/**
 * Movie Reviews with User Details
 * - Develop a GET route at '/movies/:movieId/reviews' that allows users
 *   to fetch movie reviews with associated user details. Utilize the
 *   getMovieReviewsWithUserDetails fn to handle the retrieval. Handle
 *   errors proficiently.
 *   1. Create a GET Route: Set up a GET route at '/movies/:movieId/reviews'
 *      to handle requests for fetching movie reviews with user details.
 *   2. Retrieve Reviews: In the route handler, use the getMovieReviewsWithUserDetails
 *      fn to retrieve the move reviews with associated user details for
 *      the specified movie.
 *   3. Success Response: If the reviews are successfully retrieved, 
 *      respond with the array of reviews along with user details. 
...
/**
 * Request: GET /movies/61524b6b6a7a11abc1234567/reviews
*/