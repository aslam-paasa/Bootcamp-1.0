 ...
 *    - if it is, update the user's isVerified field to true
 *    - return a success message
 * 
 * Note: isVerified is a boolean field that is used to check if the user has 
 *       verified their email. Once the user verifies their email, they can
