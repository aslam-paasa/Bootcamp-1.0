/**
 * Q. How to handle POST request?
 * => When building web applications, it's common to use HTTP POST
 *    requests to send data from the client(e.g., a form submission)
 *    to the server. In Express.js, handling POST requests involves
 *    using middleware to parse the incoming data and defining route
 *    handlers to process the data accordingly.
 * */ 

/**
 * Middleware for Parsing JSON and Form Data:
 * => Before handling POST requests, it's important to include middleware
 *    to parse the incoming data. Express provides built-in middleware
 *    for handling JSON and form data. Add the following middleware to 
 *    your Express App:
*/
