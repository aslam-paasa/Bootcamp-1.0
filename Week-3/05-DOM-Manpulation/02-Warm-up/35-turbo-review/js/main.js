...
/**
 * Q. Declare a variable and assign it to a sentance as a string. Alert if the sentance is a question
*/
let str = "Is this the best week ever?"
console.log(str.endsWith("?")); // true

/**
 * Q. Declare a variable, assign it a string of multiple words, replace every
 *    "jr. dev" with "software engineer", and print it to the console
*/
