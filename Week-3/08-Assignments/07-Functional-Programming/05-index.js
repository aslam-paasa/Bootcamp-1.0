/**
 * Write an ES6 fn that takes an array of objects containing student
 * information(name, age, grade) and returns an array with only the
 * students who have a grade above a certain value.
*/
