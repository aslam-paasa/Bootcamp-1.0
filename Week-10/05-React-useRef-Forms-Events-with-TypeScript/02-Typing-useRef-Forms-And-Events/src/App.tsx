 ...
 * 1. Objective:
 *    > In this exercise, you'll practice typing React hooks such as useRef, 
 *      handling forms, and typing events in TypeScript. 
 *    > You will create components that utilize these concepts with proper 
 *      type annotations.
 * 
 * 2. Instructions:
 *    Step-1: Typing useRef:
 *    1. Create a file named FocusInput.tsx in the src directory.
 *    2. Define a component that uses useRef to focus an input field when a 
 *       button is clicked. Type the ref appropriately.
 * 
 *    Step-2: Typing Forms:
