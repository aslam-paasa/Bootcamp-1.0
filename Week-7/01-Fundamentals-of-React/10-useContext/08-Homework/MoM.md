...
1. Add the product details route. On Click on the title, it should
   go to a page.
...
4. Club similar items by increasing the quantity
   ...
   4.2. every time there's an update you check if the item is there,
        if yes, update the quantity, if not, update the item.
