...
API calls:
14. Making API Call [done]
15. API Call on Button click - console [done]
16. API Call on Button Click - view [done]
17. API call on Button Click - view with highlight [done]
...
26. Working with Text Inputs and useState [done]
27. Working with Text Inputs and useState [done]
28. Search on an Array [done]

Working with Dropdown and useState
29. Working with Dropdown and useState [done]

Working with Checkboxes and useState
30. Working with Checkboxes and useState [done]
...
React Router
34. Setup Router [done]
35. Adding Links to Navigate [done]
36. URL params to create unique links for each product [done]
37. NavLink and active Class [done]
