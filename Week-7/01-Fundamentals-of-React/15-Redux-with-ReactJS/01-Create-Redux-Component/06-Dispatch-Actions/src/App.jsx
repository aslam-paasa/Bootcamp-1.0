 ...
 * 
 * Challenge-6: Dispatch Actions
 * In the App.jsx file, use the useDispatch hook to acess the dispatch fn
 * from Redux. Implement the handleClick function to dispatch actions when
 * the 'add' and 'minus' buttons are clicked.
*/
