  ...
  return (
    <div className="flex flex-wrap w-full">
      {matchesData.map(({ matchDetailsMap: { match, key: date } }) => {
        return match.map(
          ({
            matchInfo: { team1, team2, status, matchId, matchDesc, state },
            matchScore,
          }) => {
            return (
              <Link
                  ...
                  <div>
                    <div className="flex justify-between">
                      <div className="flex gap-6">
                        <img
                          ...
                          src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267650/iplTeamLogo/${team1.imageId}`}
                          alt={team1.teamSName}
                        />
                        <p>{team1.teamSName}</p>
                      </div>
                    ...
                    <div className="flex justify-between">
                      <div className="flex gap-6">
                        <img
                          className="w-4 object-contain"
                          src={`https://res.cloudinary.com/digkgdovw/image/upload/v1715267650/iplTeamLogo/${team2.imageId}`}
                          alt={team2.teamSName}
                        />
                        <p>{team2.teamSName}</p>
                      </div>
