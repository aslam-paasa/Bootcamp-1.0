 ...
 *
 * Route mein "*" wildcard hai:
 *   { path: '*', element: <NotFound /> }
 *
 * Koi bhi path match nahi hua → yahan aayega.
...
export default function NotFound() {
    ...
    const location = useLocation()   // current path — user ko dikhao kya type kiya tha
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
            ...
            <p className="text-gray-500 mt-2 mb-6">
                ...
                <br />
                Router mein <code className="bg-gray-100 px-1 rounded">*</code> wildcard ne pakda.
            </p>
            <button
                onClick={() => navigate('/')}
