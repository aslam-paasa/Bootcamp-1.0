/**
 * Write an ES6 fn that takes an array of objects containing game
 * information(title, developer, genre) and returns an array with all
 * the games of a certain genre.
*/
