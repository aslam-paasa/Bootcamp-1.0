...
/**
 * Q. Declare a variable, reassign it to your fav holiday, make sure it is 
...
/**
 * Q. Declare a variable, assign it a string, alert the last three characters 
...
/**
 * Q. Create a function that takes in 5 numbers. Subtract all five from 100. 
...
/**
 * Q. Create a function that takes in 3 numbers. Console log lowest and 
...
/**
 * Q. Create a function that returns heads or tails randomly and as fairly 
...
/**
 * Q. Create a function that takes in a number. Console log the result of 
 *    heads or tails using the previous function x times where x is the 
 *    number passed into the function. Call the function.
*/
