 ...
 *  - initialise a result variable in the constructor and keep updating
 *    it after every arithmetic operation
 ...
 *  - calculate: takes a string expression which can take multi-arithmetic
 *    operations and give its result
 *    
 * Example input: `10 + 2 * (6 - (4 + 1) / 2) + 7`
 * Points to Note: 
 * 1. the input can have multiple continuous spaces, you're supposed to
 *    avoid them and parse the expression correctly
